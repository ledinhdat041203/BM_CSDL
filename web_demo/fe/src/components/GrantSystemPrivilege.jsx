...
import privilegeOptions from "../constant/privileges";
import { findRoleNameAPI } from "../API/roleApi";
import { grantSysPermissionAPI } from "../API/permissionAPI";
import { toast } from "react-toastify";

function GrantSystemPrivilege() {
  ...
  const grantSysPermission = async () => {
    ...
    let response;
    try {
      response = await grantSysPermissionAPI({
        name: selectedObject,
        permission,
        grantOption,
      });
...
export default GrantSystemPrivilege;
