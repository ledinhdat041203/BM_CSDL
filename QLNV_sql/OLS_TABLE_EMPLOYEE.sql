...
UPDATE managerdb.employees SET OLS_DEPT = char_to_label('ACCESS_DEPARTMENT', 'CONF:TECH')WHERE job_title='Trưởng phòng' AND DEPARTMENT_ID = 'pb01'; 
UPDATE managerdb.employees SET OLS_DEPT = char_to_label('ACCESS_DEPARTMENT', 'CONF:FIN')WHERE job_title='Trưởng phòng' AND DEPARTMENT_ID = 'pb02';
UPDATE managerdb.employees SET OLS_DEPT = char_to_label('ACCESS_DEPARTMENT', 'CONF:BUS')WHERE job_title='Trưởng phòng' AND DEPARTMENT_ID = 'pb03';
UPDATE managerdb.employees SET OLS_DEPT = char_to_label('ACCESS_DEPARTMENT', 'CONF:MAR')WHERE job_title='Trưởng phòng' AND DEPARTMENT_ID = 'pb04';
UPDATE managerdb.employees SET OLS_DEPT = char_to_label('ACCESS_DEPARTMENT', 'CONF:HR') WHERE job_title='Trưởng phòng' AND DEPARTMENT_ID = 'pb05';
